...
{
    internal ref struct CellStateDataBlobBuilderHashMapData<TKey> 
        where TKey : struct, IEquatable<TKey>
    {
        private BlobBuilderArray<CellStateData> values;
        ...
        internal bool TryAdd(TKey key, CellStateData item, bool multi)
        {
        ...
        internal CellStateDataBlobBuilderHashMapData(int capacity, int bucketCapacityRatio, ref BlobBuilder blobBuilder, ref CellStateDataBlobHashMapData<TKey> data)
        {
